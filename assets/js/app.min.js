            ...
            : ((e = e.add(this.parent())),
              this.each(function() {
                  var i,
                      ...
                      c = 'show.bs.dropdown',
                      p = t.extend(!0, {}, { delay: 0, hoverDelay: 0, instantlyCloseOthers: !0 }, n, l);
                  function u(t) {
                      o.clearTimeout(i),
                          o.clearTimeout(a),
        ...
        $(window).scroll(function() {
            i ||
                ($(window).scrollTop() > 120 &&
                    (n.addClass('shrink'), e.addClass('bd-scroll'), n.addClass('fixed-top')),
                $(window).scrollTop() < 121 &&
                    (n.removeClass('shrink'), e.removeClass('bd-scroll'), n.removeClass('fixed-top')));
        }),
                    ...
                    t(o || this.options.inputElements)
                        ...
                        .each(function() {
                            ...
                            0 !== n.length ||
                                'hidden' === o.attr('type') ||
                                o.attr('hidden') ||
                                (o.wrap("<div class='form-group'></div>"), (n = o.closest('.form-group'))),
                                o.attr('data-hint') &&
                                    (o.after("<p class='help-block'>" + o.attr('data-hint') + '</p>'),
                                    o.removeAttr('data-hint'));
                            if (
                                (t.each({ 'input-lg': 'form-group-lg', 'input-sm': 'form-group-sm' }, function(t, e) {
    ...
    (function(t, o, n, e) {
        ...
        (r.prototype.init = function() {
                ...
                if (!a.isTouch() || 'mousedown' !== e.type) {
                    ...
                    if (s || r) {
                        var l = a.getRipplesColor(n),
                            c = t('<div></div>');
                        c.addClass('ripple').css({ left: r, top: s, 'background-color': l }),
                            i.append(c),
            ...
            (r.prototype.getRelX = function(t, o) {
                var n = t.offset();
                return a.isTouch()
                    ? 1 === (o = o.originalEvent).touches.length && o.touches[0].pageX - n.left
                    : o.pageX - n.left;
            }),
            (r.prototype.getRelY = function(t, o) {
                var n = t.offset();
                return a.isTouch()
                    ? 1 === (o = o.originalEvent).touches.length && o.touches[0].pageY - n.top
                    : o.pageY - n.top;
            }),
...
function tabs() {
    for (var t = $('.nav.nav-tabs'), o = {}, n = {}, e = 0; e < t.length; e++) {
        ...
        $(a[a.length - 1]).hasClass('ms-tabs-indicator') ||
            ($(t[e]).data('id', i), $(t[e]).append('<span id="i' + i + '" class="ms-tabs-indicator"></span>'));
        var r = $('#i' + i);
        (o['tabW' + i] = []), (n['tabL' + i] = []);
        var l = o['tabW' + i],
            c = n['tabL' + i],
        ...
        for (m = 0; m < s; m++)
            (c[m] = p),
                ...
                $(a[m])
                    .children()
                    .hasClass('active') && r.css({ left: c[m] + 'px', width: l[m] + 'px' }),
                (p += l[m]);
    }
    $('.nav.nav-tabs > li').click(function(t) {
        ...
        for (var i = a.children(), s = 0; s < i.length - 1; s++)
            $(i[s]).hasClass('current') &&
                $('#i' + e).css({ left: n['tabL' + e][s] + 'px', width: o['tabW' + e][s] + 'px' });
    });
}
