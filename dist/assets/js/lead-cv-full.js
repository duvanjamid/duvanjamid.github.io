...
function introFull() {
    ...
    e.height();
    $(window).width() < 768
        ? (r.css('marginTop', '0px'), $('#intro-video').addClass('hidden'), e.addClass('intro-full-content-static'))
        : (t.css('height', $(window).height() + 'px'),
          e.removeClass('intro-full-content-static'),
          $(window).height() / $(window).width() > 0.563197
